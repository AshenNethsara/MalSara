...
if (pb.WORKTYPE == 'private') {
    Sara.addCommand({ pattern: '.', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    Sara.addCommand({ pattern: '.', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        if(message.fromMe) return
        let command = [ 
        'xmedia',
        'install',
