...
let msg = Config.LANG == 'SI' ? '*This Plugin is Officially Approved!* ✅' : '*This Plugin is Officially Approved!* ✅'
let unmsg = Config.LANG == 'SI' ? '*This Plugin isn\'t Officially Approved!* ❌' : '*This Plugin isn\'t Officially Approved!* ❌'
...
var LANG = {
            unaffinfo: Config.LANG == 'SI' ? '*Danger Level of Installed Plugin:* _%' : '*Danger Level of Installed Plugin:* _%',
            harmful: Config.LANG == 'SI' ? '*This Plugin Cannot Be Installed As It Is Harmful!*' : '*This Plugin Cannot Be Installed As It Is Harmful!*',
            duplicate: Config.LANG == 'SI' ? '*You Cannot Install the Same Plugin 2 Times!*' : '*You Cannot Install the Same Plugin 2 Times!*',
            limit: Config.LANG == 'SI' ? '*This Plugin Exceeds Security Limit!*\n*Percentage of Harm:* _%' : '*This Plugin Exceeds Security Limit!*\n*Percentage of Harm:* _%',
            imside: Config.LANG == 'SI' ? '*You Cant Reinstall Existing Plugins!*' : '*You Cant Reinstall Existing Plugins!*'
};
Sara.addCommand({pattern: 'install ?(.*)', fromMe: true, desc: Lang.INSTALL_DESC, warn: Lang.WARN}, (async (message, match) => {
    ...
    if (response.statusCode == 200) {
        ...
        try {
            ...
            fs.unlinkSync('/root/MalSara/plugins/' + plugin_name + '.js')
...
Sara.addCommand({pattern: 'plugin$', fromMe: true, desc: Lang.PLUGIN_DESC}, (async (message, match) => {
    ...
    if (plugins.length < 1) {
        ...
        plugins.map(
            (plugin) => {
                let vf = plugin.dataValues.url.includes('ashennethsara') ? msg : unmsg
...
Sara.addCommand({pattern: 'remove(?: |$)(.*)', fromMe: true, desc: Lang.REMOVE_DESC}, (async (message, match) => {
